 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.impl.ComponentDocumentationFilesImpl#getMainteneance <em>Mainteneance</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.impl.ComponentDocumentationFilesImpl#getInstructions <em>Instructions</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.impl.ComponentDocumentationFilesImpl#getTrainingIntern <em>Training Intern</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.impl.ComponentDocumentationFilesImpl#getTrainingExternal <em>Training External</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.impl.ComponentDocumentationFilesImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.impl.ComponentDocumentationFilesImpl#getDocumentedComponent <em>Documented Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentDocumentationFilesImpl extends MinimalEObjectImpl.Container implements ComponentDocumentationFiles {
	...
	protected EClass eStaticClass() {
		return KAMP4aPSFieldofactivityannotationsPackage.Literals.COMPONENT_DOCUMENTATION_FILES;
	}
	...
	public EList<MainteneanceDocumentation> getMainteneance() {
		if (mainteneance == null) {
			mainteneance = new EObjectContainmentWithInverseEList<MainteneanceDocumentation>(MainteneanceDocumentation.class, this, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__MAINTENEANCE, KAMP4aPSFieldofactivityannotationsPackage.MAINTENEANCE_DOCUMENTATION__PARENT);
		}
		return mainteneance;
	}
	...
	public EList<OperatorInstructions> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentWithInverseEList<OperatorInstructions>(OperatorInstructions.class, this, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__INSTRUCTIONS, KAMP4aPSFieldofactivityannotationsPackage.OPERATOR_INSTRUCTIONS__PARENT);
		}
		return instructions;
	}
	...
	public EList<TrainingDocIntern> getTrainingIntern() {
		if (trainingIntern == null) {
			trainingIntern = new EObjectContainmentWithInverseEList<TrainingDocIntern>(TrainingDocIntern.class, this, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__TRAINING_INTERN, KAMP4aPSFieldofactivityannotationsPackage.TRAINING_DOC_INTERN__PARENT);
		}
	...
	public EList<TrainingDocExternal> getTrainingExternal() {
		if (trainingExternal == null) {
			trainingExternal = new EObjectContainmentWithInverseEList<TrainingDocExternal>(TrainingDocExternal.class, this, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__TRAINING_EXTERNAL, KAMP4aPSFieldofactivityannotationsPackage.TRAINING_DOC_EXTERNAL__PARENT);
		}
	...
	public DocumentationSpecification getParent() {
		if (eContainerFeatureID() != KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT) return null;
	...
	public NotificationChain basicSetParent(DocumentationSpecification newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(DocumentationSpecification newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, KAMP4aPSFieldofactivityannotationsPackage.DOCUMENTATION_SPECIFICATION__COMPONENT_DOCUMENTATION, DocumentationSpecification.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT, newParent, newParent));
	}
		...
		if (documentedComponent != null && documentedComponent.eIsProxy()) {
			...
			if (documentedComponent != oldDocumentedComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__DOCUMENTED_COMPONENT, oldDocumentedComponent, documentedComponent));
			}
		}
	...
	public void setDocumentedComponent(Component newDocumentedComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__DOCUMENTED_COMPONENT, oldDocumentedComponent, documentedComponent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__MAINTENEANCE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getMainteneance()).basicAdd(otherEnd, msgs);
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__INSTRUCTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInstructions()).basicAdd(otherEnd, msgs);
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__TRAINING_INTERN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTrainingIntern()).basicAdd(otherEnd, msgs);
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__TRAINING_EXTERNAL:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTrainingExternal()).basicAdd(otherEnd, msgs);
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT:
				return eInternalContainer().eInverseRemove(this, KAMP4aPSFieldofactivityannotationsPackage.DOCUMENTATION_SPECIFICATION__COMPONENT_DOCUMENTATION, DocumentationSpecification.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__PARENT:
				return getParent();
			case KAMP4aPSFieldofactivityannotationsPackage.COMPONENT_DOCUMENTATION_FILES__DOCUMENTED_COMPONENT:
