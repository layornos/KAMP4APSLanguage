...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4aps.model.DeploymentContext.ComponentCorrelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentCorrelationItemProvider 
	 ...
	 * @generated
	 */
	public ComponentCorrelationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentCorrelation_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentCorrelation_name_feature", "_UI_ComponentCorrelation_type"),
				 DeploymentContextPackage.Literals.COMPONENT_CORRELATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentContextPackage.Literals.COMPONENT_CORRELATION__VARIABLE_MAPPING);
		}
	...
	/**
	 * This returns ComponentCorrelation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComponentCorrelation"));
	}
	...
	public String getText(Object object) {
		String label = ((ComponentCorrelation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentCorrelation_type") :
			getString("_UI_ComponentCorrelation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComponentCorrelation.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeploymentContextPackage.Literals.COMPONENT_CORRELATION__VARIABLE_MAPPING,
				 DeploymentContextFactory.eINSTANCE.createVariableMapping()));
	}
