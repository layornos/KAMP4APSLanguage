...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4aps.model.aPS.ComponentRepository.ConveyorBelt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConveyorBeltItemProvider extends ComponentItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentRepositoryPackage.Literals.CONVEYOR_BELT__FRAME);
			childrenFeatures.add(ComponentRepositoryPackage.Literals.CONVEYOR_BELT__RUBBER_BAND);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentRepositoryPackage.Literals.CONVEYOR_BELT__FRAME,
				 ComponentRepositoryFactory.eINSTANCE.createFrame()));

		newChildDescriptors.add
			(createChildParameter
				(ComponentRepositoryPackage.Literals.CONVEYOR_BELT__RUBBER_BAND,
