...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4aps.model.aPS.ElectronicComponents.ElectronicPart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElectronicPartItemProvider extends ComponentItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ElectronicComponentsPackage.Literals.ELECTRONIC_PART__PIN);
			childrenFeatures.add(ElectronicComponentsPackage.Literals.ELECTRONIC_PART__PHYSICALCONNECTION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ElectronicPart.class)) {
