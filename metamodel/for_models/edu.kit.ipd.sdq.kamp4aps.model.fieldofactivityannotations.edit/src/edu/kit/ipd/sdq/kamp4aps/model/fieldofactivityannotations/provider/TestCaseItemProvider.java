...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4aps.model.fieldofactivityannotations.TestCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestCaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TestCase_testName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TestCase_testName_feature", "_UI_TestCase_type"),
				 KAMP4aPSFieldofactivityannotationsPackage.Literals.TEST_CASE__TEST_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TestCase)object).getTestName();
