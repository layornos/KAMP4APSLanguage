 ...
 * @generated NOT
 */
public class UserDecisionConfirmAction implements IActionDelegate {
...
private ISelection selection;
	...
	public void run(IAction action) {
		...
		if (selectedElement != null && selectedElement instanceof AbstractModification) {
			...
			if (oldState != AcceptanceAndConfirmationState.CONFIRMED) {
				modification.setUserDecision(AcceptanceAndConfirmationState.CONFIRMED);
			}
		}
	}
